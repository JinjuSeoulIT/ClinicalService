...
@CrossOrigin(origins = {"http://localhost:3001", "http://127.0.0.1:3001", "http://localhost:5173", "http://192.168.1.64:3001"})   //CORS정책
@RestController
...
public class DiagnosisController {
    ...
    public ResponseEntity<ApiResponse<DiagnosisResponse>> create(
        ...
        DiagnosisResponse result = DiagnosisResponse.from(chartService.createDiagnosis(noteId, patientCode, diagnosisCode, description));
    ...
    public ResponseEntity<ApiResponse<DiagnosisResponse>> get(
        ...
        DiagnosisResponse result = DiagnosisResponse.from(chartService.getDiagnosis(diagnosisId));
    ...
    public ResponseEntity<ApiResponse<List<DiagnosisResponse>>> list(@PathVariable("noteId") Long noteId) {
        ...
        List<DiagnosisResponse> list = chartService.listDiagnosisByNoteId(noteId).stream()
