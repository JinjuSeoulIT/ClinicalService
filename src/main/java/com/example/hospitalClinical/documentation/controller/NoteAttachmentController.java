...
public class NoteAttachmentController {
    ...
    public ResponseEntity<ApiResponse<NoteAttachmentResponse>> create(
        ...
        NoteAttachmentResponse result = NoteAttachmentResponse.from(noteService.createAttachment(noteId, fileName, filePath, fileType));
    ...
    public ResponseEntity<ApiResponse<NoteAttachmentResponse>> get(
        ...
        NoteAttachmentResponse result = NoteAttachmentResponse.from(noteService.getAttachment(attachmentId));
    ...
    public ResponseEntity<ApiResponse<List<NoteAttachmentResponse>>> list(@PathVariable("noteId") Long noteId) {
        ...
        List<NoteAttachmentResponse> list = noteService.listAttachmentByNoteId(noteId).stream()
