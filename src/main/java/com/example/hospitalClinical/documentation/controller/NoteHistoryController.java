...
public class NoteHistoryController {
    ...
    public ResponseEntity<ApiResponse<NoteHistoryResponse>> create(
        ...
        NoteHistoryResponse result = NoteHistoryResponse.from(noteService.createNoteHistory(noteId, changeType, changedBy));
    ...
    public ResponseEntity<ApiResponse<NoteHistoryResponse>> get(
        ...
        NoteHistoryResponse result = NoteHistoryResponse.from(noteService.getNoteHistory(historyId));
    ...
    public ResponseEntity<ApiResponse<List<NoteHistoryResponse>>> list(@PathVariable("noteId") Long noteId) {
        ...
        List<NoteHistoryResponse> list = noteService.listNoteHistoryByNoteId(noteId).stream()
