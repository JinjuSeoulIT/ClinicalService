...
public class VisitSoapDiagnosis {
    ...
    protected VisitSoapDiagnosis() {}

    public static VisitSoapDiagnosis create(Long visitId, String dxCode, String dxName, boolean main, int sortOrder) {
        VisitSoapDiagnosis d = new VisitSoapDiagnosis();
        d.visitId = visitId;
        d.dxCode = dxCode;
        d.dxName = dxName;
        d.mainYn = main ? "Y" : "N";
